...
var getViewForSwagger2 = function(opts, type){
    ...
    _.forEach(swagger.paths, function(api, path){
        ...
        _.forEach(api, function(op, m){
            ...
            var returnType = (op.responses["200"] ||  op.responses["201"] ||  op.responses["205"]) && (op.responses["200"] ||  op.responses["201"] ||  op.responses["205"]).schema.properties;

            _.forEach(returnType, function(parameter, key) {
                ...
                method.returnType.push(parameter);
            });
